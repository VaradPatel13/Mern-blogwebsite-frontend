        ...
        <header className="h-18 px-4 md:px-8 flex items-center justify-between border-b border-[#c0c8c3]/10 bg-[#fbf9f5]/80 backdrop-blur-md sticky top-0 z-30 shrink-0">
          <div className="flex items-center gap-4 md:gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="hidden sm:block text-[10px] font-black uppercase tracking-widest text-[#414944]/50">Canvas Mode — Ready for Bloom</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 md:gap-4">
            ...
            <button
               ...
               disabled={loading}
               className="px-6 py-2.5 md:px-8 bg-[#00261b] text-white text-[11px] font-black uppercase tracking-widest rounded-full shadow-lg hover:shadow-xl hover:bg-[#214f3f] transition-all hover:-translate-y-0.5"
            >
              Cultivate
            </button>
          </div>
